...
import { Briefcase,  SearchIcon, Building, Users, CheckCircleIcon } from "lucide-react";
  ...
  return (
   <main>
    ...
    <div className="container mx-auto px-4 text-center text-black">
      <h1 className="text-4xl text-[#7263f3] md:text-5xl font-bold mb-6">Find your dream job or perfect Candidate</h1>
      ...
      <section className="py-20 bg-[#f0f5fa]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why choose {" "}
            <span className="text-[#7263f3] font-extrabold">JobCatalyst</span>
          </h2>
